// RhinoBrushPlugIn.cpp : defines the initialization routines for the plug-in.
//
#include <fstream>
#include "StdAfx.h"
...
RHINO_PLUG_IN_NAME(L"RhinoBrush");

// Rhino plug-in id
// Provide a unique uuid for this plug-in.
RHINO_PLUG_IN_ID(L"B0FB9C67-972B-4A36-A2D3-F2FDD8022B2F");
...
RHINO_PLUG_IN_DESCRIPTION(L"RhinoBrush plug-in for Rhinoceros®");
...
// The one and only CRhinoBrushPlugIn object
static class CRhinoBrushPlugIn thePlugIn;

/////////////////////////////////////////////////////////////////////////////
// CRhinoBrushPlugIn definition
...
CRhinoBrushPlugIn::CRhinoBrushPlugIn()
{
	// Description:
...
const wchar_t* CRhinoBrushPlugIn::PlugInName() const
{
	// Description:
...
const wchar_t* CRhinoBrushPlugIn::PlugInVersion() const
{
	// Description:
...
GUID CRhinoBrushPlugIn::PlugInID() const
{
	// Description:
	...
	// {B0FB9C67-972B-4A36-A2D3-F2FDD8022B2F}
...
BOOL CRhinoBrushPlugIn::OnLoadPlugIn()
{
	// Description:
...
void CRhinoBrushPlugIn::OnUnloadPlugIn()
{
	// Description:
